...
Trade Control transacts in a country’s prevailing Unit of Account (UOA). This repository, however, maps a bitcoin wallet to the interior of the [Trade Control Node](https://github.com/tradecontrol/sqlnode) using [NBitcoin](https://github.com/metacoSA/NBitcoin), such that it too can become a UOA.
...
- [node](https://github.com/tradecontrol/sqlnode) >= 3.28.3
- [network](https://github.com/tradecontrol/network) >= 1.2.0
- [office](https://github.com/tradecontrol/office) >= 3.14.0
